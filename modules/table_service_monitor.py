...
class TableServiceMonitor:
    def __init__(self, channel_id, socketio, db_manager=None, app=None):
        ...
        self.settings = {
            ...
            "unclean_duration_threshold": 60.0,  # Only alert if table stays unclean (no person) for > 60 seconds
    ...
    def _check_unclean_violation(self, table_id, tracking, unclean_duration, current_time, frame=None):
        ...
        # For table cleanliness: Only use GIF, don't save JPG snapshot for Telegram
        ...
        logger.info(f"[{self.channel_id}] 📸 Table cleanliness GIF will be used as snapshot (no JPG saved)")
