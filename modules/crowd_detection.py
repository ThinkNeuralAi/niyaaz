    ...
    def process_frame(self, frame):
        ...
        if gathering_clusters:
            ...
            if should_alert:
                ...
                # Check if store is in operation hours before logging to database
                    ...
                    try:
                        ...
                        if rtsp_link:
                            ...
                            if not store_in_operation:
                                logger.info(f"[{self.channel_id}] Store {store_id} is not in operation hours - suppressing crowd alert")
                                return
                    except Exception as e:
