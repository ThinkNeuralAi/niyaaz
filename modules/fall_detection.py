                ...
                try:
                    ...
                    if rtsp_link:
                        ...
                        if not store_in_operation:
                            logger.info(f"[{self.channel_id}] Store {store_id} is not in operation hours - suppressing fall detection alert")
                            # Still log/emit real-time but don't save to database
                            return
                except Exception as e:
